...
- **scripts** — вспомогательные утилиты: переключение лимита заряда батареи, блокировка экрана, скриншоты всего экрана и по выделенной области (в буфер и файл), автозапуск v2rayN, ротация обоев
